define(["type/abstract/AliveGameObject", "type/PlayerProjectile", "type/abstract/Projectile"],
  function(AliveGameObject, PlayerProjectile, Projectile) {
    ...
    var PlayerShip = function() {
      ...
      this.setSprite("playership_halfengine_forward");
      this.setSize({
        width: 39,
        height: 36
      });
